...
class VacationWeekPage extends StatefulWidget {
  final MainModel model;

  VacationWeekPage(this.model);

  State<StatefulWidget> createState() => _VacationWeekPageState();
}

class _VacationWeekPageState extends State<VacationWeekPage> {
  @override
  void initState() { 
